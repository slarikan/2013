...
#http://download.java.net/jdk8/archive/b61/binaries/jdk-8-ea-bin-b61-linux-x64-18_oct_2012.tar.gz
#http://download.java.net/jdk8/archive/b61/binaries/jdk-8-ea-bin-b61-linux-i586-18_oct_2012.tar.gz

WorkDir = get.ARCH()
NoStrip = "/"
Name = "8-ea-bin-b61"
Arch = "x64" if get.ARCH() == "x86_64" else "i586"
Archive = "jdk-%s-linux-%s-18_oct_2012.tar.gz" % (Name, Arch)
Url = "http://download.java.net/jdk8/archive/b61/binaries/%s" % Archive
...
def setup():
    ...
    hash = run_batch("cat %s.sha1sum" % Arch)[1].split()[0]
...
#    shelltools.system("sh ../%s --noregister" % Archive)
